...
flags.DEFINE_string('dataset', 'sunda_kuno', 'The name of dataset [mnist, fashion-mnist')
# flags.DEFINE_string('dataset', 'khmer', 'The name of dataset [mnist, fashion-mnist')
flags.DEFINE_boolean('save_train_test', False, 'Save dataset or not')
flags.DEFINE_string('dataset_pre', 'dataset2', 'The name of dataset [mnist, fashion-mnist')
flags.DEFINE_boolean('koropak28_test', False, 'The name of dataset test [koropak 28 or not')
flags.DEFINE_boolean('is_training', True, 'train or predict phase')
flags.DEFINE_string('aksara_test', '', 'predict an aksara')
flags.DEFINE_integer('k_fold', 0, 'the fold number of cross validation')
flags.DEFINE_boolean('gan', False, 'with GAN or not')
flags.DEFINE_integer('sampling_threshold', 0, 'the threshold number for upsampling and downsampling')
