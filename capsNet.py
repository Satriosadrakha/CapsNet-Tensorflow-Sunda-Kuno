...
class CapsNet(object):
    def __init__(self, is_training=True, height=28, width=28, channels=1, num_label=28):
        """
        Args:
    ...
    def build_arch(self):
        ...
        with tf.variable_scope('Decoder'):
            ...
            # fc1 = tf.contrib.layers.fully_connected(vector_j, num_outputs=512,activation_fn=tf.nn.leaky_relu)
            ...
            # print(type(tf.Session().run(self.decoded)))
